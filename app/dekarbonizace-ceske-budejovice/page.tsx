...
const FAQS = [
  { q: "Jak se objednám na dekarbonizaci v Českých Budějovicích?", a: "Zavolejte nám na +420 601 269 600, napište e-mail nebo vyplňte formulář níže. Ozveme se do 24 hodin a domluvíme termín, který vám vyhovuje. Fungujeme výhradně na objednání." },
  { q: "Kde přesně se pobočka v Českých Budějovicích nachází?", a: "Naše budějovická pobočka sídlí na adrese Rudolfovská tř. 612, České Budějovice. Snadno dostupné z centra, parkování přímo u provozovny." },
  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", paddingTop: "60px", overflow: "hidden" }}>
      <div style={{ position: "absolute", inset: 0 }}>
        <Image
          src="/ceske-budejovice.jpg"
          alt="České Budějovice — vodíková dekarbonizace motoru" fill
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 w-full relative" style={{ paddingTop: "40px", paddingBottom: "40px" }}>
        ...
        <nav aria-label="breadcrumb" className="flex items-center gap-1 mb-6" style={{ fontSize: "0.78rem", color: "rgba(255,255,255,0.5)", fontFamily: FONT }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.8)" }}>Dekarbonizace České Budějovice</span>
        </nav>

        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 lg:gap-12 items-center">
          <div>
            <span style={{ ...S.tag, color: C.orange }}>Vodíková dekarbonizace motoru · České Budějovice</span>
            ...
            <h1 style={{ fontFamily: FONT, fontSize: "clamp(2.2rem, 5.5vw, 4.2rem)", fontWeight: 700, color: "#fff", lineHeight: 1.1, letterSpacing: "-1.5px", margin: 0 }}>
              ...
              <span style={{ color: C.orange }}>v Českých Budějovicích</span>
            </h1>
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "clamp(0.95rem, 2vw, 1.1rem)", lineHeight: 1.75, marginTop: "20px", maxWidth: "520px" }}>
              Profesionální vodíková dekarbonizace na pobočce České Budějovice — Rudolfovská tř. 612. Obnovíme výkon vašeho motoru, snížíme spotřebu a připravíme vás na STK. Bez demontáže, za 50–80 minut.
            </p>
            <div className="flex flex-wrap gap-3 mt-8">
              <a href="#contact" style={btnPrimary}
                onMouseEnter={e => (e.currentTarget.style.background = C.orangeDk)}
                onMouseLeave={e => (e.currentTarget.style.background = C.orange)}>
                Objednat v Č. Budějovicích <ArrowRight size={15}/>
              </a>
            ...
            {sent ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  ...
                  <input name="Pobocka" type="hidden" value="České Budějovice" />
    ...
    <section style={{ background: "#1a1a1a", padding: "40px 0" }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            { icon: <MapPin size={18}/>, title: "Adresa pobočky", val: "Rudolfovská tř. 612, Č. Budějovice", sub: "Parkování přímo u provozovny", href: "https://maps.google.com/?q=Rudolfovsk%C3%A1+612,+%C4%8Cesk%C3%A9+Bud%C4%9Bjovice" },
            { icon: <Clock size={18}/>, title: "Otevírací doba", val: "Po–Pá: 8:00–18:00", sub: "Výhradně na objednání" },
...
function Benefits() {
  const items = [
    { icon: <Fuel size={22}/>, title: "Nižší spotřeba paliva", desc: "Čistý motor spaluje efektivněji. Zákazníci z Českých Budějovic hlásí úsporu až 1 litr na 100 km hned po první dekarbonizaci." },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          <div>
            ...
            <div className="mt-8">
              <Image src="/auto-vw.jpg" alt="Vodíková dekarbonizace České Budějovice — HHO přístroj připojený k motoru"
    ...
    <section className="py-16 lg:py-24" style={{ background: "#161616" }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3">
              {[
                ...
                "50–80 minut — počkáte přímo u nás v Českých Budějovicích",
          ...
          <div>
            <Image src="/motor-detail.jpg" alt="Vodíková dekarbonizace České Budějovice — HHO hadice v sání motoru"
    ...
    <section id="pricing" className="py-16 lg:py-24" style={{ background: "#111" }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-8">
        <div className="flex flex-wrap justify-between items-end gap-6 mb-10">
          <div>
            <span style={{ ...S.tag, color: C.orange }}>Ceník · České Budějovice</span>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-8 lg:gap-16 items-start">
          <div>
            ...
            <h2 style={{ ...S.h2, color: C.white }}>Vše o dekarbonizaci v Č. Budějovicích</h2>
            <div style={S.divider} />
...
function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const formData = new FormData(e.currentTarget);
    formData.append("access_key", "88d43b16-7eeb-46ee-9c4e-3c60da81b2db");
    formData.append("subject", "Nová poptávka — České Budějovice");
    formData.append("from_name", "Čištění Vodíkem - Č. Budějovice kontaktní formulář");
    try {
      const response = await fetch("https://api.web3forms.com/submit", { method: "POST", body: formData });
      const data = await response.json();
      if (data.success) {
        setSent(true);
        if (typeof window !== "undefined" && (window as any).gtag) {
          (window as any).gtag("event", "generate_lead", { event_category: "form", event_label: "contact_cb", send_to: "G-RNLHTENSDQ" });
          (window as any).gtag("event", "conversion", { send_to: "AW-18028160012/yuN9CJyp9oscEIzIv5RD" });
        }
      } else {
    ...
    <section id="contact" className="py-16 lg:py-24" style={{ background: C.orange }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-8 lg:gap-16 items-start">
          <div>
            <span style={{ ...S.tag, color: C.dark }}>Objednávka · České Budějovice</span>
            ...
            <div className="flex flex-col gap-4 mt-8">
              {[
                ...
                { icon: <MapPin size={16}/>, label: "Adresa", val: "Rudolfovská tř. 612, České Budějovice", href: "https://maps.google.com/?q=Rudolfovsk%C3%A1+612,+%C4%8Cesk%C3%A9+Bud%C4%9Bjovice" },
            ...
            {sent ? (
              ...
              <div style={{ background: C.white, border: "none", borderTop: `4px solid ${C.dark}`, padding: "28px 24px" }}>
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  <input type="checkbox" name="botcheck" className="hidden" style={{ display: "none" }} />
                  <input name="Pobocka" type="hidden" value="České Budějovice — Rudolfovská tř. 612" />
                  ...
                  <button type="submit" disabled={isSubmitting} className="w-full flex items-center justify-center gap-2 mt-1 disabled:opacity-70 disabled:cursor-not-allowed"
                    ...
                    {isSubmitting ? "Odesílám..." : "Objednat se v Č. Budějovicích"} <ArrowRight size={15}/>
                  </button>
                </form>
              </div>
            )}
...
export default function CeskeBudejovicePage() {
  return (
    <>
      <Navbar />
      <Hero />
